...
#' core computational function used by [calculate_geometric_attributes()] and
...
#'
#' For processing multiple polygons, use [calculate_geometric_attributes()]
#' (sequential) or [calculate_geometric_attributes_parallel()] (parallel).
#'
#' @export
#'
#' @examples
