...
For large datasets with many polygons, use `calculate_geometric_attributes_parallel()` for faster processing:
...
**Solution**: Use parallel processing for better performance:
```{r performance}
