...
`geomattR` provides tools for calculating geometric and morphometric attributes of spatial polygons. Whether you're analyzing building footprints, administrative boundaries, habitat patches, or land parcels, this package makes it easy to extract meaningful shape and size measurements using geodesic calculations for accuracy.

All measurements in geomattR use geodesic methods, ensuring accurate results regardless of whether your data uses geographic (lon/lat) or projected coordinate reference systems.
